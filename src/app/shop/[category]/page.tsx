...
export async function generateStaticParams() {
  const cats: Category[] = await fetch('https://norrcollective.vercel.app/api/products').then((res) => res.json());
  ...
  return (
    <>
      <header className="mt-12.5 md:mt-14.5 lg:mt-23 border-r border-base-900 lg:grid lg:grid-cols-2">
        <div className="border-l border-b border-base-900 flex items-center justify-center overflow-clip relative lg:sticky lg:top-23 lg:h-[calc(100svh-92px)] self-start">
          <Image
            loading="eager"
            priority={true}
            fetchPriority="high"
